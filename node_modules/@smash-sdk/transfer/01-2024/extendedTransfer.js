...
exports.ExtendedTransfer = void 0;
const core_1 = require("@smash-sdk/core");
const UploadTransferFilePartError_1 = require("../10-2019/types/UploadTransferFilePart/UploadTransferFilePartError");
const errors_1 = require("./errors");
class ExtendedTransfer extends core_1.Client {
    constructor(params) {
        super(params);
            ...
            try {
                ...
                if (this.isValidStatusCode(response.statusCode) === true) {
                    ...
                    if (this.errors.DownloadError[errorsNames[response.statusCode]]) {
                        ...
                        reject(new core_1.UnknownError("Unsupported error code " + response.statusCode));
                    }
                }
            }
            catch (error) {
    ...
    uploadTransferFilePart(params) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const request = new core_1.HttpRequest(requestParams);
                const [response, crc32] = yield Promise.all([
                ...
                if (this.isValidStatusCode(response.statusCode)) {
                    if (typeof response.headers.etag === 'undefined') {
                        reject(new UploadTransferFilePartError_1.EtagIsMissingError());
                    }
                    else {
                        const parsedResponse = { part: { etag: response.headers.etag, crc32 } };
                    ...
                    if (this.errors.UploadTransferFilePartError[error.name]) {
                        ...
                        reject(new core_1.UnknownError(error.name));
                    }
                }
            }
            catch (error) {
...
exports.ExtendedTransfer = ExtendedTransfer;
...
function crc32ComputeBuffer(data) {
    const crc32Initial = 0xFFFFFFFF;
    const table = [0, 1996959894, -301047508, -1727442502, 124634137, 1886057615, -379345611, -1637575261, 249268274, 2044508324,
...
function isArrayLikeOrArrayBuffer(item) {
    if ((0, core_1.isNode)()) {
...
//# sourceMappingURL=extendedTransfer.js.map